...
Ext.onReady(function() {
	...
	Ext.create('Ext.window.Window',{
		...
		modal:true ,			//设置一个模态窗口,禁止操作组件外
		//plain:true ,
		icon:'resources/browser_window.png',				//字符串参数,图片的路径
		//iconCls:'' ,   		//CSS样式
		x:50 ,
		y:50 ,
		autoScroll:true,		//添加滚动条
		html:'<div style=width:200px;height:200px><img src="resources/view.png"/>我是一个div</div><div style=width:200px;height:200px>我是第二个div</div>' ,
